...
export class Backend implements backendInterface {
    ...
    async addLaptop(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addLaptop(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllLaptops(): Promise<Array<Laptop>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllLaptops();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLaptopsByBrand(arg0: string): Promise<Array<Laptop>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLaptopsByBrand(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
